...
async def main():
    ...
    async with async_playwright() as p:
        ...
        users_db = split_list(users_db, wanted_parts=len(devices))
        ...
        async def blah(device, index):
            users_chunk = users_db[index]
            print(index)
            print(users_chunk)
        ...
        asyncio.gather(
            *[blah(device, index) for index, device in enumerate(devices)],
